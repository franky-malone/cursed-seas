...
- Took part in the Navigator tools course, but unfortunately needed more
  time than expected. He nevertheless concluded it successfully.
- Studied for the exam with Jhandril and Jori as tutors while also
  attending the Hall of Lore for several weeks.
- He comissioned some wonderfully cloacks and brooches with the newly
...
- He took the course of the "Secrets of the Marshlands" and "Forgotten
  Cults and Their Rites" learning some information about The cursed
  Swamps, Kurz O'ktar and a forgotten cult to an insectoid like demon.
  - Traders avoid the Cursed Swamps, rumours about witches/hags, a large
    danger are moscitoes as large as a dove (Stirges) that live in
    groups and spread diseases
  - Emerald Mangroves: Kurz Oktar (city of monsters), orcs, goblins,
    trolls
  - Cult of Deep Sahelas (elven sea god), power was overtaken by Selune
    and Umberlee
...
- He carved the gravings of Kespien's birthday present.
- He also spent some time (with the help of Virgula) searching for raw
  materials to create a non metal breastplate.

Virgula

- Took the courses "Undead Lore and Anathema" learning about the
  different undead creatures and about Dhampirs and "Empires of Old: A
  Comparative Study" learning the point of view from Norberians about
  Marsander and also about the lost empire of Samir.
- Helped Jori searching for raw materials.
- Spent quite a bit of time gambling and gain some riches.
- Heard some rumors:
  - A small coastal town near Wolfsruhe had been massacred by some
    creature. All inhabitants were decapitated by having their heads bit
    off. The town was totally ransacked and pillaged.
  - The city of Orchiva is said to be cursed, merchants avoid it and
...
- Took the time to learn how to steer boats (Vehicles Water) and do
  build/repair work (Carpenter tools)
- He also researched how much would a captain cost for a sea travel,
  around 2-10 GP for a skilled honest individual.
- He went to a branch of the Radiant Lions and underwent an
  investigation (under a Zone of Truth) to prove that he was indeed the
  person he was. He managed to persuade the Lions to allow him to be a
  loose member of the corpse because he had leads on the long seeked
  criminal Tom Lancil.
- He contacted the underwold, specially the Shadows Void and paid them
...
The group gave presents to Kespien:

Jori created a Happy Birthday sign in the clouds with the Skywrite
spell.

Virgula managed to create fireworks with the newly acquired Wand of
Pyrotechnics

They all comissioned a wooden case for Kespien mother's Spellbook so it
would be protected against water and other elements. It was wonderfully
engraved with scenes of Kespien's life and also the name of their
fellowship.

Jhandril gave Kespien a Badge of the Savant for the abjuration school.
...
ape and in charge of the area of Numeromancy. Melrea was some kind of
...
the Farbound Fellowship, which she happened to know. She strongly
...
blade had been sold to an interplanar being named Ralto whose market was
accesible via some kind of snail portal. She then left in a portal, not
...
name of Velen's Herzblatt wife. And that they found a tomb in the crypts
